        ...
        <Card fullWidth className="mx-auto max-w-7xl">
          ...
          <CardBody>
            ...
            <div className="prose prose-invert mb-6 max-w-none sm:mb-8">
              <p><strong>NESTS Transform - Cải tạo Nests</strong> là tính năng tăng lực chiến rất mạnh, cường hóa các chỉ số cơ bản và chỉ số phụ, đồng thời có thể thay đổi thứ tự tuyệt kỹ (chế độ tự động) của các võ sĩ, với 2 phần cơ bản là Hạt nhân (Core) và Cơ năng (Part).</p>
            </div>
          </CardBody>
        </Card>
      </main>
