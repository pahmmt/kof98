                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex cursor-pointer items-center gap-2 rounded-br-lg rounded-tl-lg border border-orange-400/25 p-2 drop-shadow hover:bg-orange-400/25">
                            ...
                            <div className="flex-1 space-y-1">
                              ...
                              <div className="text-sm">
                                Bắt đầu từ vòng đầu tiên, võ sĩ linh hồn rùa sẽ thực hiện một pha
                                nguy hiểm hoặc nó sẽ kích hoạt sau khi thực hiện tổng cộng 2 pha
                                nguy hiểm trong vòng này.
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex cursor-pointer flex-col gap-2 rounded-br-lg rounded-tl-lg border border-orange-400/25 px-2 py-4 drop-shadow">
                            ...
                            <div className="flex items-center gap-4">
                              ...
                              <div className="flex-1">
                                Sau khi vào trận, bạn sẽ tăng vĩnh viễn tỷ lệ sát thương của bản
                                thân thêm 15%, tỷ lệ tránh sát thương thêm 30% và tỷ lệ chặn đòn
                                thêm 10%, khe kỹ năng số 1 được mở.
                              </div>
                            </div>
                            <Divider className="my-2" />
                            <div className="flex items-center gap-4">
                              ...
                              <div className="flex-1">
                                Thêm 150% sát thương phòng thủ của chính nó, kỹ năng 2 được kích
                                hoạt, +1 số lần sử dụng
                              </div>
                            </div>
                            <Divider className="my-2" />
                            <div className="flex items-center gap-4">
                              ...
                              <div className="flex-1">
                                Phục hồi 12% máu tối đa cho người chiến đấu có lượng máu thấp nhất
                                và thêm máu tương đương 200% khả năng phòng thủ của chính mình; Kỹ
                                năng 3 đang bật
                              </div>
                            </div>
                            <Divider className="my-2" />
                            <div className="flex items-center gap-4">
                              ...
                              <div className="flex-1">
                                ...
                                hiểm đã học (hiệu ứng kiểm soát được tăng lên bởi xác suất kích
                                hoạt); Khi bạn có thẻ, bạn có thể chơi từ vòng đầu tiên
                              </div>
                            </div>
                            <Divider className="my-2" />
                            <div className="flex items-center gap-4">
                              ...
                              <div className="flex-1">
                                ...
                                tất cả các pha nguy hiểm của kẻ thù và thêm chúng vào kỹ năng này
                                (nếu bạn nhận được buff, hãy thêm nó vào người triệu hồi); Khi bạn
                                lần đầu tiên phát hành hỗ trợ của mình, bạn có thể hồi sinh một
                                chiến binh ngẫu nhiên về phía bạn một lần, khôi phục 30% sức khỏe
                                của bạn và thừa hưởng sự tức giận; Số lần sử dụng +1
                              </div>
                            </div>
                          </div>
                        </div>
